...
library(raster)
dir.create("data")
bel1 <- getData("GADM", country = "BEL", level = 1, path = "basicmapping/data")
bel2 <- getData("GADM", country = "BEL", level = 2, path = "basicmapping/data")
```
...
alt <- getData("alt", country = "Belgium", path = "basicmapping/data")
```
