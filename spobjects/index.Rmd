...
corse <- readRDS("spobjects/data/corse-admin.rds")
rivers <- readRDS("spobjects/data/corse-rivers.rds")
cities <- readRDS("spobjects/data/corse-cities.rds")
...
corse      <- readRDS("spobjects/data/corse-admin.rds")
elevation  <- readRDS("spobjects/data/corse-elevation.rds")
landcover  <- readRDS("spobjects/data/corse-landcover.rds")
occurrence <- readRDS("spobjects/data/corse-occurrence.rds")
