...
dir.create("import/data")

# Download csv file from web page in your working directory
if (!file.exists("import/data/ruisso.csv")) {
  download.file(
    ...
    destfile = "import/data/ruisso.csv"
  )
}

# Read csv file in R
pts <- read.csv("import/data/ruisso.csv", header = TRUE, dec = ",")
```
...
```{r convert_to_sf, eval= TRUE, message = FALSE}
pts_sf <- st_as_sf(
  x = pts,
...
```{r export, warnings = FALSE}
st_write(pts_sf, "import/data/pts_sf.shp", delete_dsn = TRUE)
```
...
if (!file.exists("import/data/bois.dbf")) {
  download.file("https://data.montreal.ca/dataset/29791562-f050-401e-b405-5c1fbf427f65/resource/9fa20d3a-5dee-43d6-9bc9-5d86fe225e16/download/bois.zip", destfile = "import/bois.zip")
  unzip("import/bois.zip", exdir = "import/data")
  unlink("import/bois.zip")
}

# Read shapefile in R
bois <- st_read(dsn = "import/data", layer = "bois")
head(bois)
```
...
```{r read_geojson}
# Download shapefile from web page in your working directory
if (!file.exists("import/data/courseau.geojson")) {
  download.file("https://data.montreal.ca/dataset/c128aff5-325c-4599-ab66-1c9d0b3abc94/resource/0f64976e-19c1-4d29-bcc5-4b663a392617/download/courseau.geojson", destfile = "import/data/courseau.geojson")
}
# For GeoJSON, dsn may be the character string holding the geojson data
courseau <- st_read(dsn = "import/data/courseau.geojson")
head(courseau)
...
```{r read_tif, warning = FALSE}
# Download tif file from web page in your working directory
if (!file.exists("import/data/660_CLASS_3m.tif")) {
  download.file("https://data.montreal.ca/dataset/c128aff5-325c-4599-ab66-1c9d0b3abc94/resource/0f64976e-19c1-4d29-bcc5-4b663a392617/download/courseau.geojson", destfile = "import/canopee.zip")
  unzip("import/canopee.zip", exdir = "import/data")
  unlink("import/canopee.zip")
}
...
canopee_mtl <- raster("import/data/660_CLASS_3m.tif")
```
