...
<center>![](custommaps/img/example1.png){width=80%}</center>
...
<center>![](custommaps/img/layout1.png){width=90%}</center>
...
<center>![](custommaps/img/example2.png){width=90%}</center>

And here is the actual figure!

<center>![](custommaps/img/layout2.png){width=90%}</center>
